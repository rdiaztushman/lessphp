 ...
 * formatter, like `lesscFormatter` which then outputs CSS as a string.
 *
 ...
 *
 * The `lesscFormatter` takes a CSS tree, and dumps it to a formatted string,
...
class lessc {
	...
	public function __construct($fname = null) {
		...
		$parentPath = __FILE__ . '/lessc';
		self::discover('lessc', $parentPath, true);
		
		spl_autoload_register( 'lessc::load');
	}
	...
	protected function newFormatter() {
		...
		if (!empty($this->formatterName)) {
			...
			$className = "lesscFormatter$this->formatterName";
		}
